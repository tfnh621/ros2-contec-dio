...
long DioReadCountSR(short Id, short *ChNo, short ChNum, unsigned int *Count, unsigned short *Timestamp, unsigned char Mode);
long DioDmSetDirection(short id, unsigned long Direction);
long DioDmGetDirection(short id, unsigned long *Direction);
